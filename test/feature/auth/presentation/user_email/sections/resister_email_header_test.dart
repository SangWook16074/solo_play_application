...
import 'package:solo_play_application/src/features/auth/presentation/user_email/sections/resister_email_header.dart';

void main() {
  group(ResisterEmailHeader, () {
    late Widget widget;
